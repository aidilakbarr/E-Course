    ...
    <main class="w-full min-h-screen transition-all main">
            ...
            <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                <div class="flex justify-between mb-6">
                    <div>
                        ...
                        <div class="text-sm font-medium text-gray-400">Total Kursus</div>
                    </div>
            ...
            <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                <div class="flex justify-between mb-4">
                    <div>
                        ...
                        <div class="text-sm font-medium text-gray-400">Total Pendaftaran</div>
                    </div>
            ...
            <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                <div class="flex justify-between mb-6">
                    <div>
                        ...
                        <div class="text-sm font-medium text-gray-400">Pendaftaran minggu ini</div>
                    </div>
                </div>
            </div>
        </div>
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                <div class="rounded-t mb-0 px-0 border-0">
                    <div class="flex flex-wrap items-center px-4 py-2">
                        <div class="relative w-full max-w-full flex-grow flex-1">
                            <h3 class="font-semibold text-base text-gray-900 dark:text-gray-50">Kursus Terpopuler</h3>
                        </div>
                    </div>
            ...
            <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
                <div class="flex justify-between mb-4 items-start">
                    <div class="font-medium">Pendaftaran Course Terbaru</div>
                </div>
                        ...
                        <tbody>
                            <tr>
                                <td class="py-2 px-4 border-b border-b-gray-50">
                                    <div class="flex items-center">
                                        <a href="#"
                                            class="text-gray-600 text-sm font-medium hover:text-blue-500 ml-2 truncate">Aidil
                                            Akbar</a>
                                    </div>
                                </td>
                                <td class="py-2 px-4 border-b border-b-gray-50">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md lg:col-span-2">
                <div class="flex justify-between mb-4 items-start">
                    <div class="font-medium">Pendaftaran Statistics</div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
                    <div class="rounded-md border border-dashed border-gray-200 p-4 ">
                        ...
                        <span class="text-gray-400 text-sm">Total Pendaftaran</span>
                    </div>
                    <div class="rounded-md border border-dashed border-gray-200 p-4">
                        <div class="flex items-center mb-0.5">
                            <div class="text-xl font-semibold">50</div>
                        </div>
                        <span class="text-gray-400 text-sm">Pendaftaran selesai</span>
                    </div>
                    <div class="rounded-md border border-dashed border-gray-200 p-4">
                        <div class="flex items-center mb-0.5">
                            <div class="text-xl font-semibold">4</div>
                        </div>
                        <span class="text-gray-400 text-sm">Pendaftaran dibatalan</span>
                    </div>
                </div>
                <div>
                            ...
                            <tr>
                                <td class="py-2 px-4 border-b border-b-gray-50">
                                    <div class="flex items-center">
                                        ...
                                        <a href="#"
                                            class="text-gray-600 text-sm font-medium hover:text-blue-500 ml-2 truncate">Belajar
                                            python</a>
                                    </div>
                                </td>
                                <td class="py-2 px-4 border-b border-b-gray-50">
